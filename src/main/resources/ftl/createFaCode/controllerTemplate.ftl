package com.huanqiuyuncang.controller.${packageName}.${objectNameLower};
...
import com.huanqiuyuncang.service.${packageName}.${objectNameLower}.${objectName}Manager;
import com.huanqiuyuncang.service.${packageName}.${objectNameLower}mx.${objectName}MxManager;
