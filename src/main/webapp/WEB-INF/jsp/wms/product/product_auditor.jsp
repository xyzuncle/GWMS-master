                        ...
                        <form action="product/${msg }.do" name="Form" id="Form" method="post" enctype="multipart/form-data">
                            ...
                            <div id="zhongxin" style="padding-top: 13px;">
                                <table id="table_report" class="table table-striped table-bordered table-hover">
                                   ...
                                   <input type="hidden" id="auditStatus" name="auditStatus" value="${product.auditStatus}">
                                    <tr>
                                        <td style="text-align: center;" colspan="10">
                                            <a class="btn btn-mini btn-primary" onclick="save(1);">通过</a>
                                            <a class="btn btn-mini btn-primary" onclick="save(0);">不通过</a>
                                            <a class="btn btn-mini btn-primary" onclick="save(2);">停用</a>
...
<script type="text/javascript">
    ...
    //保存
    function save(auditor){
        $("#auditStatus").val(auditor);
