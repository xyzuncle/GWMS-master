					...
					<form action="country/${msg }.do" name="Form" id="Form" method="post">
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<tr>
								...
								<td><input type="text" name="COUN_C_NAME" id="COUN_C_NAME" value="${pd.COUN_C_NAME}" maxlength="20" placeholder="这里输入中文名称" title="中文名称" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">英文名称:</td>
								<td><input type="text" name="COUN_E_NAME" id="COUN_E_NAME" value="${pd.COUN_E_NAME}" maxlength="50" placeholder="这里输入英文名称" title="英文名称" style="width:98%;"/></td>
							</tr>
							<tr>
