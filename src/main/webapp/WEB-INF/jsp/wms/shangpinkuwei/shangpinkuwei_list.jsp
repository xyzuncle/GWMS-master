    ...
    <div class="main-content">
        <div class="main-content-inner">
            <div class="page-content">
                <div class="row">
                    <div class="col-xs-12">
                        <form action="shangpinkuwei/list.do" method="post" name="Form" id="Form">
                            <table style="margin-top:5px;">
                                <tr>
                                    <td>
                                        ...
                                        <span class="input-icon">
                                            <input type="text" placeholder="这里输入关键词" class="nav-search-input" id="nav-search-productnum" autocomplete="off" name="productnum" value="${pd.customernum }" placeholder="这里输入关键词"/>
                                        </span>
                                        <span class="input-icon">
                                            默认仓库：
                                        </span>
...
<script type="text/javascript">
    ...
    function del(Id){
        bootbox.confirm("确定要删除吗?", function(result) {
            if(result) {
                top.jzts();
                var url = "<%=basePath%>shangpinkuwei/delete.do?id="+Id+"&tm="+new Date().getTime();
            ...
            if(result) {
                ...
                if(str==''){
                    ...
                    if(msg == '确定要删除选中的数据吗?'){
                        ...
                        $.ajax({
                            type: "POST",
                            url: '<%=basePath%>shangpinkuwei/deleteAll.do?tm='+new Date().getTime(),
                            data: {DATA_IDS:str},
                            dataType:'json',
