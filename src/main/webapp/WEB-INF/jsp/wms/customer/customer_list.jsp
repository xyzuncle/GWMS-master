                                                ...
                                                <tr>
                                                    ...
                                                    <td class="center">
                                                        ...
                                                        <div class="hidden-sm hidden-xs btn-group">
                                                            <a class="btn btn-xs btn-primary" onclick="viewProduct('${var.customerid}');">
                                                        ...
                                                        <div class="hidden-md hidden-lg">
                                                            <div class="inline pos-rel">
                                                                ...
                                                                <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                                                    ...
                                                                    <c:if test="${QX.edit == 1 }">
                                                                        <li>
                                                                            <a style="cursor:pointer;" onclick="edit('${var.customerid}');" class="tooltip-success" data-rel="tooltip" title="修改">
																	<span class="green">
                                                                    ...
                                                                    <c:if test="${QX.del == 1 }">
                                                                        <li>
                                                                            <a style="cursor:pointer;" onclick="del('${var.customerid}');" class="tooltip-error" data-rel="tooltip" title="删除">
																	<span class="red">
