                            ...
                            <div id="zhongxin" style="padding-top: 13px;">
                                <table id="table_report" class="table table-striped table-bordered table-hover">
                                    <tr>
                                        ...
                                        <td>
                                            <select class="chosen-select form-control"
                                                    disabled
                                                    name="customernum" disabled id="customernum" data-placeholder="请选择" style="vertical-align:top;width:98%;">
                                        ...
                                        <td><input type="text" disabled name="outerordernum" id="outerordernum" value="${innerorder.outerordernum}" maxlength="30" style="width:98%;"/></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3"><input disabledtype="text" name="senderaddress" id="senderaddress" value="${innerorder.senderaddress}" maxlength="30" style="width:98%;"/></td>
                                    </tr>
                                    <tr>
                                        <td style="width:82px;text-align: right;padding-top: 13px;">收件人:</td>
                                        <td><input type="text" disabled name="recipient" id="recipient"  value="${innerorder.recipient}" maxlength="30"  style="width:98%;"/></td>
                                        <td style="width:82px;text-align: right;padding-top: 13px;">收件人身份证:</td>
                                        <td><input type="text" disabled name="recipientidcard" id="recipientidcard"  value="${innerorder.recipientidcard}" maxlength="30"  style="width:98%;"/></td>
                                    </tr>
                                    <tr>
                                        <td style="width:82px;text-align: right;padding-top: 13px;">收件人电话:</td>
                                        <td><input type="text"disabled name="recipientphone" id="recipientphone"  value="${innerorder.recipientphone}" maxlength="30"  style="width:98%;"/></td>
                                        <td style="width:82px;text-align: right;padding-top: 13px;">收件人国家:</td>
                                        <td>
                                            <select disabled class="chosen-select form-control" style="vertical-align:top;width:98%;"  id="recipientcountry" name="recipientcountry" >
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select  disabledid="recipientprovince"  style="vertical-align:top;width:98%;" name="recipientprovince" onchange="changeprovince(this.value)">
                                                <option>请选择</option>
                                            </select>
                                        ...
                                        <td>
                                            <select disabled id="recipientcity" style="vertical-align:top;width:98%;" name="recipientcity" onchange="changeCity(this.value)">
                                                <option>请选择</option>
                                            </select>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select disabled id="recipientarea" style="vertical-align:top;width:98%;" name="recipientarea" >
                                                <option>请选择</option>
                                            </select>
                                        ...
                                        <td><input disabled type="text" name="recipientpostcode" id="recipientpostcode"  value="${innerorder.recipientpostcode}" maxlength="30"  style="width:98%;"/></td>
                                    </tr>
                                    <tr>
                                        <td style="width:82px;text-align: right;padding-top: 13px;">收件人地址:</td>
                                        <td colspan="3"><input  disabled type="text" name="recipientaddress" id="recipientaddress"  value="${innerorder.recipientaddress}" maxlength="30"  style="width:98%;"/></td>
                                    </tr>
                                    <tr>
                                        <td style="width:82px;text-align: right;padding-top: 13px;">支付方式:</td>
                                        <td><input type="text" disabled name="paymentmethod" id="paymentmethod"  value="${innerorder.paymentmethod}" maxlength="30"  style="width:98%;"/></td>
                                        <td style="width:82px;text-align: right;padding-top: 13px;">支付交易号:</td>
                                        <td><input type="text" disabled name="paymentnum" id="paymentnum"  value="${innerorder.paymentnum}" maxlength="30"  style="width:98%;"/></td>
                                    </tr>
                                    <tr>
                                        <td style="width:82px;text-align: right;padding-top: 13px;">支付时间:</td>
                                        <td><input type="text" disabled class="date-picker" name="paymenttime" id="paymenttime" data-date-format="yyyy-mm-dd" readonly="readonly" value="${innerorder.paymenttime}" maxlength="30"  style="width:98%;"/></td>
                                        <td style="width:82px;text-align: right;padding-top: 13px;">订单商品总件数:</td>
                                        <td><input type="text"
                                                disabled
                                            name="orderproductcount" id="orderproductcount"  value="${innerorder.orderproductcount}" maxlength="30"  style="width:98%;"/></td>
                                    </tr>
                                    <tr>
                                        <td style="width:82px;text-align: right;padding-top: 13px;">顾客备注:</td>
                                        <td><input type="text" disabled name="customerremarks" id="customerremarks"  value="${innerorder.customerremarks}" maxlength="30"  style="width:98%;"/></td>
                                        <td style="width:82px;text-align: right;padding-top: 13px;">报关模式:</td>
                                        <td>
                                            <select  disabled class="chosen-select form-control" name="customsmodel" id="customsmodel" data-placeholder="请选择" style="vertical-align:top;width:98%;">
                                                <option value="">请选择</option>
                                                <c:choose>
                                    ...
                                    <tr>
                                        ...
                                        <td><input disabled type="text" name="couriername" id="couriername" disabled value="${innerorder.couriername}" maxlength="30"  style="width:98%;"/></td>
                                        <td style="width:82px;text-align: right;padding-top: 13px;">快递单号:</td>
                                        <td><input disabled type="text" name="couriernum" id="couriernum" disabled value="${innerorder.couriernum}" maxlength="30"  style="width:98%;"/></td>
                                    </tr>
                                    </c:if>
                                    <tr>
                                        <td style="width:82px;text-align: right;padding-top: 13px;">订单货值:</td>
                                        <td><input disabled type="text" name="ordervalue" id="ordervalue"  value="${innerorder.ordervalue}" maxlength="30"  style="width:98%;"/></td>
                                        <td style="width:82px;text-align: right;padding-top: 13px;">申报货值:</td>
                                        <td><input disabled type="text" name="declarevalue" id="declarevalue"
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3" >
                                            <textarea disabled rows="5" cols="10" id="remark" name="remark" style="width:98%;"  title="备注1">${innerorder.remark}</textarea>
                                        </td>
                                    </tr>
                                    <c:if test="${QX.adminOrder == 1 }">
                                    <tr>
                                        ...
                                        <td colspan="3" >
                                            <textarea disabled rows="5" cols="10" id="remark1" name="remark1" style="width:98%;"  title="备注1">${innerorder.remark1}</textarea>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width:78px;height:130px;text-align: right;padding-top: 13px;">备注2:</td>
                                        <td colspan="3">
                                            <textarea disabled rows="5" cols="10" id="remark2"  name="remark2" style="width:98%;"  title="备注2">${innerorder.remark2}</textarea>
                                        </td>
                                    </tr>
                                    <tr>
