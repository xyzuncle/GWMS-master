    ...
    <div class="main-content">
        <div class="main-content-inner">
            <div class="page-content">
                <div class="row">
                    <div class="col-xs-12">
                        <form action="innerorder/chaidan.do" method="post" name="Form" id="Form">
                        <!-- 检索  -->
                                ...
                                <table style="width:100%;">
                                    <tr>
                                        <td style="vertical-align:top;">
                                            <a class="btn btn-xs btn-success" title="合单" onclick="chaidan();">
                                                拆单
                                            </a>
                                        </td>
            ...
            if(result) {
                ...
                if(str==''){
                    ...
                    if(msg == '确定要将选中的数据拆单吗?'){
                        ...
                        $.ajax({
                            type: "POST",
                            url: '<%=basePath%>innerorder/chaidan.do?tm='+new Date().getTime(),
                            data: {DATA_IDS:str},
                            dataType:'json',
                            cache: false,
