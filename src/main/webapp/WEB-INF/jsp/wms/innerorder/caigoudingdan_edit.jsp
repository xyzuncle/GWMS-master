                        ...
                        <form action="caigoudingdan/${msg }.do" name="Form" id="Form" method="post">
                            ...
                            <div id="zhongxin" style="padding-top: 13px;">
                                <table id="table_report" class="table table-striped table-bordered table-hover">
                                    <tr>
                                        ...
                                        <td><input type="text"
                                                <c:if test="${msg == 'edit' }">
                                                   ...
                                                   name="caigoudingdanhao" id="caigoudingdanhao" value="${caigoudingdan.caigoudingdanhao}" maxlength="30" style="width:98%;"/></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td style="width:90px;text-align: right;padding-top: 13px;">商品货号:</td>
                                        <td><input type="text" name="shangpinhuohao" id="shangpinhuohao" value="${caigoudingdan.shangpinhuohao}" maxlength="255"  style="width:98%;"/></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td style="width:90px;text-align: right;padding-top: 13px;">数量:</td>
                                        <td><input type="text" name="shuliang" id="shuliang" value="${caigoudingdan.kehubianhao}" maxlength="255" style="width:98%;"/></td>
                                    </tr>
                                    <tr>
                                        <td style="width:90px;text-align: right;padding-top: 13px;">采购价格:</td>
                                        <td><input type="text" name="caigoujiage" id="caigoujiage" value="${caigoudingdan.caigoujiage}" maxlength="255" style="width:98%;"/></td>
                                    </tr>
                                    <tr>
                                        <td style="width:90px;text-align: right;padding-top: 13px;">小计:</td>
                                        <td><input type="text" name="xiaoji" id="xiaoji" value="${caigoudingdan.xiaoji}" maxlength="255" style="width:98%;"/></td>
                                    </tr>
                                    <tr>
