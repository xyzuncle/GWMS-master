                            ...
                            <div id="zhongxin" style="padding-top: 13px;">
                                <table id="table_report" class="table table-striped table-bordered table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <td><input  type="text" name="shangpinhuohao" id="shangpinhuohao" value="${caigoudingdan.shangpinhuohao}" maxlength="50"  style="width:98%;"/></td>
                                    </tr>
                                    <tr>
                                        <td style="width:82px;text-align: right;padding-top: 13px;">数量:</td>
                                        <td><input  type="text" name="productnum1" id="shuliang"  value="${caigoudingdan.shuliang}" maxlength="50" style="width:98%;"/></td>
                                    </tr>
                                    <tr>
