                            ...
                            <div id="zhongxin" style="padding-top: 13px;">
                                <table id="table_report" class="table table-striped table-bordered table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <td><input  type="text" name="kehubianhao" id="kehubianhao" value="${rukubaoguo.kehubianhao}" maxlength="50" style="width:98%;"/></td>
                                    </tr>
                                    <tr>
                                        <td style="width:82px;text-align: right;padding-top: 13px;">仓位:</td>
                                        <td><input type="text" name="cangwei" id="cangwei" value="${rukubaoguo.cangwei}" maxlength="255" style="width:98%;"/></td>
                                    </tr>
                                    <tr>
