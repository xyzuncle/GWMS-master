                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="col-xs-4 label label-lg label-light arrowed-in arrowed-right">
                                        <b>${null == city.city ?'无':city.city}</b>
                                    </div>
                                </td>
                            </tr>
							<tr>
								<td style="width:70px;text-align: right;padding-top: 13px;">名称:</td>
								<td><input type="text" name="area" id="area" value="${area.area}" maxlength="50" placeholder="这里输入名称" title="名称" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:70px;text-align: right;padding-top: 13px;">编号:</td>
								<td><input type="text" name="areaid" id="areaid" value="${area.areaid}" maxlength="50" placeholder="这里输入编号" title="编号" style="width:98%;"/></td>
							</tr>
							<tr>
