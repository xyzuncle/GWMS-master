					...
					<form action="province/${msg }.do" name="Form" id="Form" method="post">
						...
						<table id="table_report" class="table table-striped table-bordered table-hover" style="margin-top:15px;">
							<tr>
								...
								<td><input type="text" name="province" id="province" value="${province.province}" maxlength="50" placeholder="这里输入名称" title="名称" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:70px;text-align: right;padding-top: 13px;">编号:</td>
								<td><input type="text" name="provinceid" id="provinceid" value="${province.provinceid}" maxlength="50" placeholder="这里输入编号" title="编号" style="width:98%;"/></td>
							</tr>
							<tr>
