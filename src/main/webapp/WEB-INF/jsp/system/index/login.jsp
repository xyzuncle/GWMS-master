...
<body>
	...
	<div style="width:100%;text-align: center;margin: 0 auto;position: absolute;">
		...
		<div id="loginbox" >
			...
			<div class="controls">
				<div class="main_input_box">
					<font color="white"><span id="nameerr">Copyright © ULink International Holding Ltd. 2017</span></font>
				</div>
			</div>
		</div>
		</div>
	...
	<script type="text/javascript">
		...
		function severCheck(){
			if(check()){
				...
				<!-- 对应login.jsp 252行 -->
				var code = "qq9551942ul"+loginname+",fh,"+password+"wms9551942ul"+",fh,"+$("#code").val();
				$.ajax({
					type: "POST",
					url: 'login_login',
