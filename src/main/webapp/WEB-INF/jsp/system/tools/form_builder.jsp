...
<body class="gray-bg">
											                    ...
											                    <div class="ibox-content">
											                        ...
											                        <form class="form-horizontal m-t">
											                            ...
											                            <div class="form-group draggable">
																			...
																			<div class="col-sm-9">
																				<div class="fileQ9551942Qfile"></div>
	...
	function getUeditorFormHtml(html,msg,isgx){
		var arryUe = html.split('<div class="ueQ9551942Que"></div>');
		if(arryUe.length == 3){
			var uejscode = "<script id=\"editor\" type=\"text/plain\" style=\"width:96%;height:200px;\"><\/script>";
			if(msg == '1'){
				if(isgx == '2'){
					ueditorHtml = arryUe[1];
					return arryUe[0] + '<div class="ueQ9551942Que"></div>' + uejscode + '<div class="ueQ9551942Que"></div>' + arryUe[2];
				}else{
					return arryUe[0] + '<div class="ueQ9551942Que"></div>' + ueditorHtml + '<div class="ueQ9551942Que"></div>' + arryUe[2];
				}
			}else{
	...
	function getSelectFormHtml(html,msg,isgx){
		var arrySe = html.split('<div class="selQ9551942Qsel"></div>');
		if(arrySe.length == 3){
			...
			if(msg == '1'){
				if(isgx == '2'){
					return arrySe[0] + '<div class="selQ9551942Qsel"></div>' + selectcode + '<div class="selQ9551942Qsel"></div>' + arrySe[2];
				}else{
					selectHtml = arrySe[1];
					return html;
				}
	...
	function getFileFormHtml(html,msg,isgx){
		var arryFile = html.split('<div class="fileQ9551942Qfile"></div>');
		if(arryFile.length == 3){
			var filecode = "<input type=\"file\" id=\"tp\" name=\"tp\" />";
			if(msg == '1'){
				if(isgx == '2'){
					fileHtml = arryFile[1];
					return arryFile[0] + '<div class="fileQ9551942Qfile"></div>' + filecode + '<div class="fileQ9551942Qfile"></div>' + arryFile[2];
				}else{
					return arryFile[0] + '<div class="fileQ9551942Qfile"></div>' + fileHtml + '<div class="fileQ9551942Qfile"></div>' + arryFile[2];
				};
			}else{
