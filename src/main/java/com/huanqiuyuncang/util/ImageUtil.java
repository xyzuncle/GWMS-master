...
public class ImageUtil {
    ...
    public static String thumbnailImage(File imgFile, int w, int h, String prevfix, boolean force){
        ...
        if(imgFile.exists()){
            try {
                ...
                // 将图片保存在原目录并加上前缀
                newfilename = p.substring(0, p.lastIndexOf(File.separator)) + File.separator + prevfix + imgFile.getName();
    ...
    public static String thumbnailImage(File imgFile, int w, int h){
