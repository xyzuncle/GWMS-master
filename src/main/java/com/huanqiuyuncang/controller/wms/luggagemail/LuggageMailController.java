package com.huanqiuyuncang.controller.wms.luggagemail;
 ...
 */
@Controller
@RequestMapping(value="/luggagemail")
public class LuggageMailController extends BaseController {
    String menuUrl = "luggagemail/list.do"; //菜单地址(权限用)
    ...
    public ModelAndView save() throws Exception{
        ...
        luggageMailService.insertSelective(pd);
    ...
    public ModelAndView goEdit()throws Exception{
        ...
        mv.addObject("luggagemail", luggageMail);
        mv.addObject("pd", pd);
        return mv;
    }
