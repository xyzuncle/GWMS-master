package com.huanqiuyuncang.dao.redis.impl;
...
import com.huanqiuyuncang.dao.AbstractBaseRedisDao;
import com.huanqiuyuncang.dao.redis.RedisDao;
import com.huanqiuyuncang.util.DbFH;
...
public class RedisDaoImpl extends AbstractBaseRedisDao<String, PageData> implements RedisDao{
	...
	/**删除
	 * (non-Javadoc)
	 * @see com.huanqiuyuncang.dao.redis.RedisDao#delete(java.lang.String)
	 */
	@Override
	...
	/**删除多个
	 * (non-Javadoc)
	 * @see com.huanqiuyuncang.dao.redis.RedisDao#delete(java.util.List)
	 */
	@Override
	...
	/**修改
	 * (non-Javadoc)
	 * @see com.huanqiuyuncang.dao.redis.RedisDao#eidt(java.lang.String, java.lang.String)
	 */
	@Override
	...
	/**通过key获取值
	 * (non-Javadoc)
	 * @see com.huanqiuyuncang.dao.redis.RedisDao#get(java.lang.String)
	 */
	@Override
